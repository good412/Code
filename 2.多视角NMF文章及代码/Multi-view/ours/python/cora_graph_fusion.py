...
if __name__ == "__main__":
    ...
    fn_fusion_result = 'data/cora_graph_fusion_results.txt'
    fn_label = 'data/cora_list_data_labels.txt'
    
    graphfusion = TTNG_MFR()
    
    fn_results = []
    fn_results.append('data/cora_rank_content.txt')
    fn_results.append('data/cora_rank_cites.txt')
    
    fn_result_rerankings = []
    fn_result_rerankings.append('data/cora_rerank_content.txt')
    fn_result_rerankings.append('data/cora_rerank_cites.txt')
