...
if __name__ == "__main__":
    ...
    fn_fusion_result = 'data/corel-10k_graph_fusion_results.txt'
    fn_label = 'data/corel-10k_list_images_labels.txt'
    
    graphfusion = TTNG_MFR()
    
    fn_results = []
    
    fn_results.append('data/corel-10k_rank_msd.txt')
    fn_results.append('data/corel-10k_rank_cdh.txt')
    fn_results.append('data/corel-10k_rank_hsv.txt')
    fn_results.append('data/corel-10k_rank_lbp.txt')
    fn_results.append('data/corel-10k_rank_bow.txt')
    fn_results.append('data/corel-10k_rank_cnn.txt')
    
    
    fn_result_rerankings = []
    fn_result_rerankings.append('data/corel-10k_rerank_msd.txt')
    fn_result_rerankings.append('data/corel-10k_rerank_cdh.txt')
    fn_result_rerankings.append('data/corel-10k_rerank_hsv.txt')
    fn_result_rerankings.append('data/corel-10k_rerank_lbp.txt')
    fn_result_rerankings.append('data/corel-10k_rerank_bow.txt')
    fn_result_rerankings.append('data/corel-10k_rerank_cnn.txt')
    ...
    for i in range(num_ranks):
        ...
        search_region = 10
        lam = 1
        graph_lists.append(build_cknn_graphs.BuildKNNGraphs(fn_result, fn_result_reranking, fn_label, 25, 110, search_region, lam))
