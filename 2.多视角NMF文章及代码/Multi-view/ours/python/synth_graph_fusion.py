...
if __name__ == "__main__":
    ...
    fn_fusion_result = 'data/synth_graph_fusion_results.txt'
    fn_label = 'data/synth_list_data_labels.txt'
    
    graphfusion = TTNG_MFR()
    
    fn_results = []
    fn_results.append('data/synth_rank_view1.txt')
    fn_results.append('data/synth_rank_view2.txt')
    #fn_results.append('data/synth_rank_view3.txt')
    
    fn_result_rerankings = []
    fn_result_rerankings.append('data/synth_rerank_view1.txt')
    fn_result_rerankings.append('data/synth_rerank_view2.txt')
    fn_result_rerankings.append('data/synth_rerank_view3.txt')
    ...
    for i in range(num_ranks):
        ...
        search_region = 10
        lam = 1
        graph_lists.append(build_cknn_graphs.BuildKNNGraphs(fn_result, fn_result_reranking, fn_label, kNN, 850, search_region, lam))
    ...
    evaluate.Evaluate(fn_label, fn_fusion_result, 100)
