...
if __name__ == "__main__":
    ...
    fn_results = []
    fn_results.append('data/corel-1k_rank_gist.txt')
    fn_results.append('data/corel-1k_rank_msd.txt')
    #fn_results.append('data/corel-1k_rank_cdh.txt')
    fn_results.append('data/corel-1k_rank_hsv.txt')
    #fn_results.append('data/corel-1k_rank_lbp.txt')
    fn_results.append('data/corel-1k_rank_bow.txt')
    fn_results.append('data/corel-1k_rank_cnn.txt')
    
    fn_result_rerankings = []
    fn_result_rerankings.append('data/corel-1k_rerank_gist.txt')
    fn_result_rerankings.append('data/corel-1k_rerank_msd.txt')
    #fn_result_rerankings.append('data/corel-1k_rerank_cdh.txt')
    fn_result_rerankings.append('data/corel-1k_rerank_hsv.txt')
    #fn_result_rerankings.append('data/corel-1k_rerank_lbp.txt')
    fn_result_rerankings.append('data/corel-1k_rerank_bow.txt')
    fn_result_rerankings.append('data/corel-1k_rerank_cnn.txt')
