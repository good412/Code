...
if __name__ == "__main__":
    ...
    fn_results.append('data/digit_rank_profile.txt')
    ...
    fn_result_rerankings.append('data/digit_rerank_profile.txt')
    ...
    for i in range(num_ranks):
        ...
        search_region = 10
        lam = 1
        graph_lists.append(build_cknn_graphs.BuildKNNGraphs(fn_result, fn_result_reranking, fn_label, 25, retri_amount, search_region, lam))
