...
if __name__ == "__main__":
    ...
    fn_fusion_result = 'data/reuter_graph_fusion_results.txt'
    fn_label = 'data/reuter_list_data_labels.txt'
    
    graphfusion = TTNG_MFR()
    
    fn_results = []
    fn_results.append('data/reuter_rank_EN.txt')
    fn_results.append('data/reuter_rank_FR.txt')
    
    fn_result_rerankings = []
    fn_result_rerankings.append('data/reuter_rerank_EN.txt')
    fn_result_rerankings.append('data/reuter_rerank_FR.txt')
    ...
    for i in range(num_ranks):
        ...
        search_region = 10
        lam = 1
        graph_lists.append(build_cknn_graphs.BuildKNNGraphs(fn_result, fn_result_reranking, fn_label, kNN, 350, search_region, lam))
    ...
    evaluate.Evaluate(fn_label, fn_fusion_result, 10)
