...
if __name__ == "__main__":
    ...
    fn_fusion_result = 'data/texas_graph_fusion_results.txt'
    fn_label = 'data/texas_list_data_labels.txt'
    
    graphfusion = TTNG_MFR()
    
    fn_results = []
    fn_results.append('data/texas_rank_cites.txt')
    fn_results.append('data/texas_rank_content.txt')
    
    fn_result_rerankings = []
    fn_result_rerankings.append('data/texas_rerank_cites.txt')
    fn_result_rerankings.append('data/texas_rerank_content.txt')
