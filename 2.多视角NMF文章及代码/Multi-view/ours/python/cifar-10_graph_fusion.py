...
if __name__ == "__main__": 
    ...
    fn_fusion_result = 'data/cifar-10_graph_fusion_results.txt'
    fn_label = 'data/cifar-10_list_images_labels.txt'
    
    graphfusion = TTNG_MFR()
    
    fn_results = []
    
    #fn_results.append('data/cifar-10_rank_hsv.txt')
    fn_results.append('data/cifar-10_rank_cnn.txt')
    fn_results.append('data/cifar-10_rank_phow.txt')
    #fn_results.append('data/cifar-10_rank_bow.txt')
   
    
    
    fn_result_rerankings = []
    fn_result_rerankings.append('data/cifar-10_rerank_hsv.txt')
    fn_result_rerankings.append('data/cifar-10_rerank_cnn.txt')
    fn_result_rerankings.append('data/cifar-10_rerank_phow.txt')
    fn_result_rerankings.append('data/cifar-10_rerank_bow.txt')
