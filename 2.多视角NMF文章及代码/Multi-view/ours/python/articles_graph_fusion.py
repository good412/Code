...
if __name__ == "__main__":
    ...
    fn_fusion_result = 'data/articles_graph_fusion_results.txt'
    fn_label = 'data/articles_list_data_labels.txt'
    
    graphfusion = TTNG_MFR()
    
    fn_results = []
    fn_results.append('data/articles_rank_image.txt')
    fn_results.append('data/articles_rank_text.txt')
    
    fn_result_rerankings = []
    fn_result_rerankings.append('data/articles_rerank_image.txt')
    fn_result_rerankings.append('data/articles_rerank_text.txt')
    ...
    for i in range(num_ranks):
        ...
        search_region = 10
        lam = 1
        graph_lists.append(build_cknn_graphs.BuildKNNGraphs(fn_result, fn_result_reranking, fn_label, 25, 300, search_region, lam))
